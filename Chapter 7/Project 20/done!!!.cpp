...
int main() {
    ...
    do {
        ...
        while (age < MAX_AGE) {
            ...
            if (randNum <= prob && age == initAge) {
                break;
            }
            if (randNum <= prob) {
                age++;
                cout << "Loop ended with random number: " << randNum << " and probability: " << prob << endl << age << endl;
                break; // User dies at current age

            }
            cout << "Loop ended with random number: " << randNum << " and probability: " << prob << endl;
            age++;
            cout << age <<endl;
